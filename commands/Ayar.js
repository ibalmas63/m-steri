...
let embed = new Discord.MessageEmbed().setFooter("Akano Guard B", message.author.avatarURL({dynamic: true})).setColor("010000").setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true}))
